...
Route::group(['middleware' => 'auth', 'master'], function () {
	    Route::get('master', 'MasterController@index')->name('master.dashboard');
	    // Route::get('master.user', 'MasterUserController@index')->name('user.index');
        Route::get('master/user/profile/{id}', 'MasterUserController@profile')->name('master.user.profile');
	    Route::put('master/user/update_profile/{id}', 'MasterUserController@profileUpdate')->name('master.user.profileUpdate');
	    Route::put('master/user/changepass/{id}', 'MasterUserController@changePassword')->name('master.user.password');
	    Route::get('master/user/genpass', 'MasterUserController@generatePassword');
	    Route::post('master/user/deletebyselection', 'MasterUserController@deleteBySelection');
	    // Route::resource('master/user','MasterUserController');
		Route::get('master/user', 'MasterUserController@index')->name('master.user.index');
		Route::get('master/user/create', 'MasterUserController@create')->name('master.user.create');
		Route::post('master/user/store', 'MasterUserController@store')->name('master.user.store');
		Route::get('master/user/edit/{id}', 'MasterUserController@edit')->name('master.user.edit');
		Route::put('master/user/update/{id}', 'MasterUserController@update')->name('master.user.update');
		Route::post('master/user/delete/{id}', 'MasterUserController@delete')->name('master.user.delete');

    	// Route::resource('master', 'MasterController');


		Route::get('master/company', 'CompanyController@index')->name('master.company.index');
		Route::get('master/company/create', 'CompanyController@create')->name('master.company.create');
		Route::post('master/company/store', 'CompanyController@store')->name('master.company.store');
		Route::get('master/company/edit/{id}', 'CompanyController@edit')->name('master.company.edit');
		Route::put('master/company/update/{id}', 'CompanyController@update')->name('master.company.update');
		Route::post('master/company/delete/{id}', 'CompanyController@delete')->name('master.company.delete');
