            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['master.user.update', $lims_user_data->id], 'method' => 'put', 'files' => true]) !!}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>{{trans('file.Company Name')}}</strong></label>
                                          <select class="form-control" name="company_id" id="company_id" value="{{$lims_user_data->company_id}}" required>
                                            <option value="{{$lims_user_data->company_id}}" selected disabled>Select Company</option>
