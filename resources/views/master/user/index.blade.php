@extends('layout.main') @section('content')
    ...
    @endif --}}
        <div class="container-fluid">
            <a href="{{ route('master.user.create') }}" class="btn btn-info"><i class="dripicons-plus"></i>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        user="menu">
                                        <li>
                                            <a href="{{ route('master.user.edit', $user->id) }}" class="btn btn-link"><i
                                                    class="dripicons-document-edit"></i> {{ trans('file.edit') }}</a>
                                        </li>
                                        <li class="divider"></li>
                                        {{ Form::open(['route' => ['master.user.delete', $user->id], 'method' => 'POST']) }}
                                        <li>
