        ...
        <div class="container-fluid">
            <div class="col-md-12">
                ...
                <div class="filter-toggle btn-group">
                    <button class="btn btn-primary date-btn" data-start_date="{{ date('Y-m-d') }}"
                        data-end_date="{{ date('Y-m-d') }}">{{ trans('file.Today') }}</button>
                    <button class="btn btn-primary date-btn" data-start_date="{{ date('Y-m-d', strtotime(' -7 day')) }}"
                    ...
                    <button class="btn btn-primary date-btn" data-start_date="{{ date('Y') . '-01' . '-01' }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="wrapper count-title text-center"
                                ...
                                <div class="name"><strong style="color: #733686">{{ trans('file.revenue') }}</strong>
                                </div>
                                <div class="count-number revenue-data">{{ number_format((float) $revenue, 2, '.', '') }}
                                </div>
                            </div>
                        </div>
                        <!-- Count item widget-->
                        <div class="col-sm-3">
                            <div class="wrapper count-title text-center"
                                ...
                                <div class="name"><strong style="color: #ff8952">{{ trans('file.Sale Return') }}</strong>
                                </div>
                        ...
                        <div class="col-sm-3">
                            <div class="wrapper count-title text-center"
                                ...
                                <div class="name"><strong
                                        style="color: #00c689">{{ trans('file.Purchase Return') }}</strong></div>
                                <div class="count-number purchase_return-data">
                                    {{ number_format((float) $purchase_return, 2, '.', '') }}</div>
                            </div>
                        </div>
                        <!-- Count item widget-->
                        <div class="col-sm-3">
                            <div class="wrapper count-title text-center"
                                ...
                                <div class="count-number profit-data">{{ number_format((float) $profit, 2, '.', '') }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="pie-chart mb-2">
                            <canvas id="transactionChart" data-color="{{ $color }}"
                                ...
                                data-label1="{{ trans('file.Purchase') }}" data-label2="{{ trans('file.revenue') }}"
                                data-label3="{{ trans('file.Expense') }}" width="100" height="95"> </canvas>
                        </div>
                    </div>
                </div>
            </div>
