                    ...
                    @if (Auth::user()->role_id == 6)
                        <li class=""><a href="#hrms" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="hrms" class="collapse list-unstyled ">
                                ...
                                <li><a href="{{ route('master.company.index') }}">Create Company</a></li>
                                <li><a href="{{ route('master.user.index') }}">Add user</a></li>
                ...
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <span class="brand-big">
                        @if ($general_setting->site_logo)
                            <img src="{{ url('/logo', $general_setting->site_logo) }}" width="50">&nbsp;&nbsp;
                        @endif
                        <a href="{{ url('/') }}">
                            <h1 class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                {{ $general_setting->site_title }}</h1>
                        </a>
                    </span>
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        {{-- <li class="nav-item">
                            <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i
                                    class="dripicons-web"></i> <span>{{ __('file.language') }}</span> <i
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                ...
                                <li>
                                    <a href="{{ url('language_switch/sw') }}" class="btn btn-link"> Swahili</a>
                                </li>
                                <li>
