            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => ['master.user.update', $lims_user_data->id], 'method' => 'put', 'files' => true]); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong><?php echo e(trans('file.Company Name')); ?></strong></label>
                                          <select class="form-control" name="company_id" id="company_id" value="<?php echo e($lims_user_data->company_id); ?>" required>
                                            <option value="<?php echo e($lims_user_data->company_id); ?>" selected disabled>Select Company</option>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/heri/Downloads/Inventory-Management-System-with-POS-HRM-Accounting-main/resources/views/master/user/edit.blade.php ENDPATH**/ ?>