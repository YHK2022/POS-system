                            ...
                            <?php if($warehouse_report_active): ?>
                                <li id="warehouse-report-menu">
                                    <a id="warehouse-report-link"
                                        href=""><?php echo e(trans('file.Warehouse Report')); ?></a>
                                </li>
                            <?php endif; ?>
        ...
        <div class="container-fluid">
            <div class="row">
                <audio id="mysoundclip1" preload="auto">
                    <source src="<?php echo e(url('public/beep/beep-timber.mp3')); ?>">
                    </source>
                </audio>
                <audio id="mysoundclip2" preload="auto">
                    <source src="<?php echo e(url('public/beep/beep-07.mp3')); ?>">
                    </source>
                </audio>
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="payment-options">
                            ...
                            <div class="column-5">
                                <button style="background: #2a066d" type="button" class="btn btn-custom payment-btn"
                            ...
                            <div class="column-5">
                                <button style="background-color: #630202" type="button"
                            ...
                            <div class="column-5">
                                <button style="background-color: #680231" type="button"
                                    class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment"
                                    id="deposit-btn"><i class="fa fa-university"></i> Deposit</button>
                            </div>
                            <div class="column-5">
                                <button style="background-color: #570404;" type="button" class="btn btn-custom"
                                    id="cancel-btn" onclick="return confirmCancel()"><i class="fa fa-close"></i>
                                    Cancel</button>
                            </div>
                            <div class="column-5">
                                <button style="background-color: #745806;" type="button" class="btn btn-custom"
                                ...
                                <div class="navbar-holder d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="navbar-header">
                                        ...
                                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                            ...
                                            <?php endif; ?>
                                            <li class="nav-item">
                                                <a href="<?php echo e(route('sales.printLastReciept')); ?>"
                                                    ...
                                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications"
                                                        ...
                                                        <li class="notifications">
                                                            <a href="<?php echo e(route('report.qtyAlert')); ?>"
                                                                class="btn btn-link"><?php echo e($alert_product); ?> product exceeds
                                                                alert quantity</a>
                                                        </li>
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route('user.profile', ['id' => Auth::id()])); ?>"><i
                                                            ...
                                                            <?php echo e(trans('file.profile')); ?></a>
                                                    </li>
                                                    <?php if($general_setting_permission_active): ?>
                                                        <li>
                                                    ...
                                                    <li>
                                                        <a
                                                            href="<?php echo e(url('holidays/my-holiday/' . date('Y') . '/' . date('m'))); ?>"><i
                                    ...
                                    <?php for($i = 0; $i < ceil($product_number / 5); $i++): ?>
                                        <tr>
                                            <td class="product-img sound-btn"
                                                ...
                                                <img src="<?php echo e(url('public/images/product', $lims_product_list[0 + $i * 5]->base_image)); ?>"
                                                    width="100%" />
                                            ...
                                            <?php if(!empty($lims_product_list[1 + $i * 5])): ?>
                                                <td class="product-img sound-btn"
                                                    ...
                                                    <img src="<?php echo e(url('public/images/product', $lims_product_list[1 + $i * 5]->base_image)); ?>"
                                                        width="100%" />
                                            ...
                                            <?php if(!empty($lims_product_list[2 + $i * 5])): ?>
                                                <td class="product-img sound-btn"
                                                    ...
                                                    <img src="<?php echo e(url('public/images/product', $lims_product_list[2 + $i * 5]->base_image)); ?>"
                                                        width="100%" />
                                            ...
                                            <?php if(!empty($lims_product_list[3 + $i * 5])): ?>
                                                <td class="product-img sound-btn"
                                                    ...
                                                    <img src="<?php echo e(url('public/images/product', $lims_product_list[3 + $i * 5]->base_image)); ?>"
                                                        width="100%" />
                                            ...
                                            <?php if(!empty($lims_product_list[4 + $i * 5])): ?>
                                                <td class="product-img sound-btn"
                                                    ...
                                                    <img src="<?php echo e(url('public/images/product', $lims_product_list[4 + $i * 5]->base_image)); ?>"
                                                        width="100%" />
    ...
    <script type="text/javascript">
        ...
        function addNewProduct(data) {
            ...
            if (!data[11] && product_warehouse_price[pos]) {
                product_price.push(parseFloat(product_warehouse_price[pos] * currency['exchange_rate']) + parseFloat(
                    product_warehouse_price[pos] * currency['exchange_rate'] * customer_group_rate));
            } else {
                product_price.push(parseFloat(data[2] * currency['exchange_rate']) + parseFloat(data[2] * currency[
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/heri/Downloads/Inventory-Management-System-with-POS-HRM-Accounting-main/resources/views/sale/pos.blade.php ENDPATH**/ ?>