        ...
        <div class="container-fluid">
            <div class="col-md-12">
                ...
                <div class="filter-toggle btn-group">
                    <button class="btn btn-primary date-btn" data-start_date="<?php echo e(date('Y-m-d')); ?>"
                        data-end_date="<?php echo e(date('Y-m-d')); ?>"><?php echo e(trans('file.Today')); ?></button>
                    <button class="btn btn-primary date-btn" data-start_date="<?php echo e(date('Y-m-d', strtotime(' -7 day'))); ?>"
                        data-end_date="<?php echo e(date('Y-m-d')); ?>"><?php echo e(trans('file.Last 7 Days')); ?></button>
                    <button class="btn btn-primary date-btn active"
                        data-start_date="<?php echo e(date('Y') . '-' . date('m') . '-' . '01'); ?>"
                        data-end_date="<?php echo e(date('Y-m-d')); ?>"><?php echo e(trans('file.This Month')); ?></button>
                    <button class="btn btn-primary date-btn" data-start_date="<?php echo e(date('Y') . '-01' . '-01'); ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="wrapper count-title text-center"
                                style="border-color:#733686; border-left-style:solid ;border-right-style:solid;">
                                <div class="icon"><i class="dripicons-graph-bar" style="color: #ab9baf;"></i></div>
                                <div class="name"><strong style="color: #733686"><?php echo e(trans('file.revenue')); ?></strong>
                                </div>
                                <div class="count-number revenue-data"><?php echo e(number_format((float) $revenue, 2, '.', '')); ?>
                        ...
                        <div class="col-sm-3">
                            <div class="wrapper count-title text-center"
                                style="border-color:#ff8952; border-left-style:solid; border-right-style:solid;">
                                <div class="icon"><i class="dripicons-return" style="color: #ff8952"></i></div>
                                <div class="name"><strong style="color: #ff8952"><?php echo e(trans('file.Sale Return')); ?></strong>
                                </div>
                                <div class="count-number return-data"><?php echo e(number_format((float) $return, 2, '.', '')); ?>
                        ...
                        <div class="col-sm-3">
                            <div class="wrapper count-title text-center"
                                style="border-color:#00c689; border-left-style:solid; border-right-style:solid;">
                                <div class="icon"><i class="dripicons-media-loop" style="color: #00c689"></i></div>
                                <div class="name"><strong
                                        style="color: #00c689"><?php echo e(trans('file.Purchase Return')); ?></strong></div>
                                <div class="count-number purchase_return-data">
                                    <?php echo e(number_format((float) $purchase_return, 2, '.', '')); ?></div>
                            </div>
                        </div>
                        <!-- Count item widget-->
                        <div class="col-sm-3">
                            <div class="wrapper count-title text-center"
                                style="border-color:#297ff9; border-left-style:solid; border-right-style:solid;">
                                ...
                                <div class="count-number profit-data"><?php echo e(number_format((float) $profit, 2, '.', '')); ?>
                ...
                <div class="col-md-7 mt-4">
                    <div class="card line-chart-example">
                        ...
                        <div class="card-body">
                            ...
                            ?>
                            <canvas id="cashFlow" data-color="<?php echo e($color); ?>" data-color_rgba="<?php echo e($color_rgba); ?>"
                                data-recieved="<?php echo e(json_encode($payment_recieved)); ?>"
                                data-sent="<?php echo e(json_encode($payment_sent)); ?>" data-month="<?php echo e(json_encode($month)); ?>"
                ...
                <div class="col-md-5 mt-4">
                    <div class="card">
                        ...
                        <div class="pie-chart mb-2">
                            <canvas id="transactionChart" data-color="<?php echo e($color); ?>"
                                data-color_rgba="<?php echo e($color_rgba); ?>" data-revenue=<?php echo e($revenue); ?>

                                data-purchase=<?php echo e($purchase); ?> data-expense=<?php echo e($expense); ?>

                                data-label1="<?php echo e(trans('file.Purchase')); ?>" data-label2="<?php echo e(trans('file.revenue')); ?>"
                                data-label3="<?php echo e(trans('file.Expense')); ?>" width="100" height="95"> </canvas>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <canvas id="saleChart" data-sale_chart_value="<?php echo e(json_encode($yearly_sale_amount)); ?>"
                                data-purchase_chart_value="<?php echo e(json_encode($yearly_purchase_amount)); ?>"
                                data-label1="<?php echo e(trans('file.Purchased Amount')); ?>"
                                data-label2="<?php echo e(trans('file.Sold Amount')); ?>"></canvas>
                        </div>
                    </div>
                </div>
                <div class="col-md-7">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#purchase-latest" role="tab"
                                    data-toggle="tab"><?php echo e(trans('file.Purchase')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#quotation-latest" role="tab"
                                    data-toggle="tab"><?php echo e(trans('file.Quotation')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#payment-latest" role="tab"
                                    data-toggle="tab"><?php echo e(trans('file.Payment')); ?></a>
                            </li>
                        </ul>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $recent_sale; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    <td><?php echo e(date($general_setting->date_format, strtotime($sale->created_at->toDateString()))); ?>
                                                    ...
                                                    <?php if($sale->sale_status == 1): ?>
                                                        <td>
                                                            <div class="badge badge-success"><?php echo e(trans('file.Completed')); ?>

                                                            </div>
                                                        </td>
                                                    <?php elseif($sale->sale_status == 2): ?>
                                                        <td>
                                                            <div class="badge badge-danger"><?php echo e(trans('file.Pending')); ?>

                                                            </div>
                                                        </td>
                                                    <?php else: ?>
                                                        <td>
                                                            <div class="badge badge-warning"><?php echo e(trans('file.Draft')); ?>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $recent_purchase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    <td><?php echo e(date($general_setting->date_format, strtotime($purchase->created_at->toDateString()))); ?>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $recent_quotation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quotation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    <td><?php echo e(date($general_setting->date_format, strtotime($quotation->created_at->toDateString()))); ?>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $recent_payment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e(date($general_setting->date_format, strtotime($payment->created_at->toDateString()))); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/heri/Downloads/Inventory-Management-System-with-POS-HRM-Accounting-main/resources/views/index.blade.php ENDPATH**/ ?>