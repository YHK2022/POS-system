            ...
            <div class="main-menu">
                <ul id="side-main-menu" class="side-menu list-unstyled">
                                ...
                                <?php if($profit_loss_active): ?>
                                    <li id="profit-loss-report-menu">
                                        ...
                                        <a id="profitLoss-link"
                                            href=""><?php echo e(trans('file.Summary Report')); ?></a>
                                        <?php echo Form::close(); ?>
                                ...
                                <?php if($payment_report_active): ?>
                                    <li id="payment-report-menu">
                                        ...
                                        <a id="payment-report-link"
                                            href=""><?php echo e(trans('file.Payment Report')); ?></a>
                                        <?php echo Form::close(); ?>
                                ...
                                <?php if($purchase_report_active): ?>
                                    <li id="purchase-report-menu">
                                        ...
                                        <a id="purchase-report-link"
                                            href=""><?php echo e(trans('file.Purchase Report')); ?></a>
                                        <?php echo Form::close(); ?>
                                ...
                                <?php if($customer_report_active): ?>
                                    <li id="customer-report-menu">
                                        <a id="customer-report-link"
                                            href=""><?php echo e(trans('file.Customer Report')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($supplier_report_active): ?>
                                    <li id="supplier-report-menu">
                                        <a id="supplier-report-link"
                                            href=""><?php echo e(trans('file.Supplier Report')); ?></a>
                                    </li>
                                <?php endif; ?>
                        ...
                        <ul id="setting" class="collapse list-unstyled ">
                            ...
                            <?php if($warehouse_permission_active): ?>
                                <li id="warehouse-menu"><a
                                        href="<?php echo e(route('warehouse.index')); ?>"><?php echo e(trans('file.Warehouse')); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if($unit_permission_active): ?>
                                <li id="unit-menu"><a
                                        href="<?php echo e(route('unit.index')); ?>"><?php echo e(trans('file.Unit')); ?></a></li>
                            <?php endif; ?>
                            ...
                            <?php if($mail_setting_permission_active): ?>
                                <li id="mail-setting-menu"><a
                                        href="<?php echo e(route('setting.mail')); ?>"><?php echo e(trans('file.Mail Setting')); ?></a>
                                </li>
                            <?php endif; ?>
                    ...
                    <?php if(Auth::user()->role_id == 6): ?>
                        <li class=""><a href="#hrms" aria-expanded="false" data-toggle="collapse"> <i
                                    class="dripicons-user-group"></i><span>MASTER</span></a>
                            <ul id="hrms" class="collapse list-unstyled ">

                                <li><a href="<?php echo e(route('master.company.index')); ?>">Create Company</a></li>
                                <li><a href="<?php echo e(route('master.user.index')); ?>">Add user</a></li>
                ...
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <span class="brand-big">
                        <?php if($general_setting->site_logo): ?>
                            <img src="<?php echo e(url('/logo', $general_setting->site_logo)); ?>" width="50">&nbsp;&nbsp;
                        <?php endif; ?>
                        <a href="<?php echo e(url('/')); ?>">
                            <h1 class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <?php echo e($general_setting->site_title); ?></h1>
                        </a>
                    </span>
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <?php if($add_permission_active): ?>
                            <li class="nav-item"><a class="dropdown-item btn-pos btn-sm"
                                    href="<?php echo e(route('sale.pos')); ?>"><i class="dripicons-shopping-bag"></i><span>
                                        POS</span></a></li>
                        <?php endif; ?>
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        $lims_account_list = \App\Account::where('is_active', true)
                            ->where('company_id', auth()->user()->company_id)
                            ->get();
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_id" class="selectpicker form-control" required data-live-search="true"
                                ...
                                <?php $__currentLoopData = $lims_user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($user->id); ?>">
                                        <?php echo e($user->name . ' (' . $user->phone . ')'); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php /**PATH /home/heri/Downloads/Inventory-Management-System-with-POS-HRM-Accounting-main/resources/views/layout/main.blade.php ENDPATH**/ ?>