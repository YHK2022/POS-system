        ...
        <div class="container-fluid">
            <?php if(in_array('expenses-add', $all_permission)): ?>
                <button class="btn btn-info" data-toggle="modal" data-target="#expense-modal"><i class="dripicons-plus"></i>
                    <?php echo e(trans('file.Add Expense')); ?></button>
            <?php endif; ?>
        </div>
                ...
                <tbody>
                    <?php $__currentLoopData = $lims_expense_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr data-id="<?php echo e($expense->id); ?>">
                            ...
                            <td><?php echo e(date($general_setting->date_format, strtotime($expense->created_at->toDateString())) . ' ' . $expense->created_at->toTimeString()); ?>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        ...
                                        <?php if(in_array('expenses-edit', $all_permission)): ?>
                                            <li><button type="button" data-id="<?php echo e($expense->id); ?>"
                                                    ...
                                                    <?php echo e(trans('file.edit')); ?></button></li>
                                        <?php endif; ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/heri/Downloads/Inventory-Management-System-with-POS-HRM-Accounting-main/resources/views/expense/index.blade.php ENDPATH**/ ?>