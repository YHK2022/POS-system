<?php $__env->startSection('content'); ?>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" name="type_hidden"
                                                    value="<?php echo e($lims_product_data->type); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="<?php echo e($lims_product_data->name); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="code" id="code"
                                                    value="<?php echo e($lims_product_data->code); ?>" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="hidden" name="barcode_symbology_hidden"
                                                    value="<?php echo e($lims_product_data->barcode_symbology); ?>">
                                                        ...
                                                        <?php $__currentLoopData = $product_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td><input type="number" class="form-control qty"
                                                                        name="product_qty[]" value="<?php echo e($qty_list[$key]); ?>"
                                                                        step="any"></td>
                                                                <td><input type="number" class="form-control unit_price"
                                                                        name="unit_price[]" value="<?php echo e($price_list[$key]); ?>"
                                                                        step="any" /></td>
                                    ...
                                    <div id="cost" class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="cost" value="<?php echo e($lims_product_data->cost); ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" value="<?php echo e($lims_product_data->price); ?>"
                                                required class="form-control" step="any">
                                            <span class="validation-msg"></span>
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" name="qty" value="<?php echo e($lims_product_data->qty); ?>"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div id="alert-qty" class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="alert_quantity"
                                                value="<?php echo e($lims_product_data->alert_quantity); ?>" class="form-control"
                                                step="any">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                    ...
                                                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><button type="button" class="btn btn-sm"><i
                                                                        class="fa fa-trash"></i></button></i></td>
                                                            <td>
                                    ...
                                    <div class="col-md-12 mt-3" id="variant-option">
                                        <?php if($lims_product_data->is_variant): ?>
                                            <h5><input name="is_variant" type="checkbox" id="is-variant" value="1"
                                                    checked>&nbsp; <?php echo e(trans('file.This product has variant')); ?></h5>
                                        <?php else: ?>
                                            <h5><input name="is_variant" type="checkbox" id="is-variant"
                                                    value="1">&nbsp; <?php echo e(trans('file.This product has variant')); ?>
                                                        ...
                                                        <tr>
                                                            <td style="cursor:grab">
                                                                ...
                                                                <input type="hidden" name="product_variant_id[]"
                                                                    value="<?php echo e($variant->pivot['id']); ?>">
                                                                <input type="hidden" name="variant_id[]"
                                                                    value="<?php echo e($variant->pivot['variant_id']); ?>">
                                                            </td>
                                                            <td><input type="text" class="form-control"
                                                                    name="variant_name[]" value="<?php echo e($variant->name); ?>" />
                                                            </td>
                                                            <td><input type="text" class="form-control"
                                                                    name="item_code[]"
                                                                    value="<?php echo e($variant->pivot['item_code']); ?>" /></td>
                                                            <td><input type="number" class="form-control"
                                                                    name="additional_price[]"
                                                                    value="<?php echo e($variant->pivot['additional_price']); ?>"
                                                                    step="any" /></td>
                                                            <td><button type="button"
                                                                    class="vbtnDel btn btn-sm btn-danger">X</button></td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="button" value="<?php echo e(trans('file.submit')); ?>"
    ...
    <script type="text/javascript">
        ...
        var lims_product_code = [
            <?php $__currentLoopData = $lims_product_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
        ...
        $("input[name='variant']").on("input", function() {
            if ($("#code").val() == '') {
                ...
                var cols = '';
                cols +=
                    '<td style="cursor:grab"><i class="dripicons-view-apps"></i><input type="hidden" name="product_variant_id[]" value="0"></td>';
                cols += '<td><input type="text" class="form-control" name="variant_name[]" value="' + variant_name +
                    '" /></td>';
                cols += '<td><input type="text" class="form-control" name="item_code[]" value="' + item_code +
                    '" /></td>';
                cols +=
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/heri/Downloads/Inventory-Management-System-with-POS-HRM-Accounting-main/resources/views/product/edit.blade.php ENDPATH**/ ?>