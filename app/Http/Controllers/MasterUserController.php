...
class MasterUserController extends Controller
{
    ...
    public function index()
    {
        ...
        //     return view('master.user.index', compact('lims_user_list', 'all_permission'));
        // } else {
        //     return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
        // }

        $lims_user_list = User::where('is_deleted', false)->whereIn('role_id', [1, 6])->get();
        // $lims_user_list = User::with('company')->get();
        // $company = DB::table('companies')->find($user->company_id);
        // dd($company);

        return view('master.user.index', compact('lims_user_list'));
    ...
    public function create()
    {
        ...
        $lims_role_list = Roles::where('is_active', true)->whereIn('id', [1, 6])->get();
        ...
        return view('master.user.create', compact('lims_role_list', 'companys', 'lims_biller_list', 'lims_warehouse_list', 'lims_customer_group_list'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect('master/user')->with('message1', $message);
    }
    ...
    public function edit($id)
    {
        ...
        return view('master.user.edit', compact('companys', 'lims_user_data', 'lims_role_list', 'lims_biller_list', 'lims_warehouse_list'));
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('master/user')->with('message2', 'Data updated successfullly');
    }
    ...
    public function delete($id)
    {
        ...
        if (Auth::id() == $id) {
            ...
            return redirect('master/user')->with('message3', 'Data deleted successfullly');
        }
